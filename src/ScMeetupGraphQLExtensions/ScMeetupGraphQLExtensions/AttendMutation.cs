...
{
    public class AttendMutation : RootFieldType<IntGraphType, int>, IContentSchemaRootFieldType
    {
        public AttendMutation() : base("attendEvent", "Attend an event")
        {
        ...
        protected override int Resolve(ResolveFieldContext context)
        {
            ...
            graphQLClient.Execute<dynamic>("AttendMutation.graphql", variables);
